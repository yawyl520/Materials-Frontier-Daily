---
layout: default
title: Materials Frontier Daily
---
...
欢迎来到 Materials Frontier Daily，一个基于 [Horizon](https://github.com/thysrael/Horizon) 搭建的材料领域前沿研究雷达。

## 文档

- [配置指南](configuration) — AI 提供商、材料信息源、过滤规则与环境变量替换
- [信息源采集器](scrapers) — Horizon 如何从期刊 RSS、arXiv 和 GitHub 采集内容
- [评分系统](scoring) — 基于 AI 的论文与研究资讯分析、0-10 评分体系
...
Welcome to Materials Frontier Daily, a materials-research radar built on [Horizon](https://github.com/thysrael/Horizon).

## Documentation

- [Configuration Guide](configuration) — AI providers, materials sources, filtering, and environment variable substitution
- [Source Scrapers](scrapers) — How Horizon collects content from journal RSS feeds, arXiv, and GitHub
- [Scoring System](scoring) — AI-based paper and research-news analysis with a 0-10 scoring scale
